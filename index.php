        ...
        <div class="container">
            <form>
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="aminoTextInput" rows="3" placeholder="Escribir secuencia de Aminoacidos aqui"></textarea>
                </div>
                <div class="form-group">
                ...
                <button type="button" class="btn btn-primary btn-lg btn-block">Traducir</button>
            </form>
        </div>
